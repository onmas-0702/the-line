...
// 오디오 업로드 시 선택하는 기본 카테고리 — 검색/분류에 사용됩니다.
...
// 배경음악 분류 — 자유 태그가 아니라 이 고정 목록 중에서 고르는 방식입니다
// (표기가 제각각이면 필터가 무의미해지는 걸 막기 위해서예요). 필요하면 이
// 목록에 항목을 추가/수정하면 되고, DB 쪽(background_tracks.genres/themes)은
// 이 값을 그대로 문자열 배열로 저장합니다.
...
export const initialPersonalTracks = [
  { id: "pbg1", name: "우리 교회 반주팀 데모곡", duration: "03:40", genres: [], themes: [] },
];
